  ...
  return (
    <View style={styles.container}>
      <Text style={styles.calculator}>Calculator</Text> 
        <Text>Calculate with React Native!</Text>
        <Text>{" "}</Text>
      <View style={styles.row}>
        ...
        <View style={styles.textInput}>
          <TextInput placeholder="0" value={number1} 
          onChangeText={text => setNumber1(text)} style={{textAlign:'right'}} 
      ...
      <View style={styles.row}>
        ...
        <View style={styles.textInput}>
          <TextInput placeholder="0" value={number2} 
